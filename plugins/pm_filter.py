...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('Update Channel', url='t.me/filmyfunda_movies'),
                    InlineKeyboardButton('Source Code', url=f'{TUTORIAL}')
                ]
                ]
            await query.message.edit(text=f"<b>Developer : <a href='https://github.com/subinps'>SUBIN</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nSource Code : <a href='{TUTORIAL}'>Click here</a>\nUpdate Channel : <a href='https://t.me/filmyfunda_movie'>filmy funda movies</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('Join our channel', url=f'https://t.me/filmyfunda_movies')
                    ]
                    ]
        ...
        await query.answer("ಇದು ಸ್ವಲ್ಪ ಹೆಚ್ಚು ಆಸಕ್ತಿದಾಯಕವಲ್ಲವೇ?👀",show_alert=True)
